...
////////////////////////////////////////////////////////////////////////
		...
		l2 = new JLabel("Сколько вам нужно");
...
////////////////////////////////////////////////////////////////////////
		...
		l8 = new JLabel("от 3 месяцев.......до 5 лет");
...
///////Actionkey
		...
		bb.addActionListener((ActionEvent e) -> {
			...
			if (box.getSelectedItem().equals("6 Месяцев")) {
			...
			if (box.getSelectedItem().equals("2 Года")) {

				n = 24;

			}

			if (box.getSelectedItem().equals("3 Года")) {

				n = 36;

			}

			if (box.getSelectedItem().equals("4 Года")) {
